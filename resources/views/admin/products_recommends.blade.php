@extends("admin_base")
@section("title") Recommended Products @endsection
@section("style")
<style>
...
<div class="col-12 mb-3">
  <h5 class="text-dark border-bottom">Add/Remove Recommended Products</h5>
</div>
...
<form method="GET">
  ...
  <a href="{{ route('admin_products_recommends') }}" class="text-muted d-none" id="reset_btn"><small>reset</small></a>
</form>
</div>
  ...
  <ul class="list-group">
    @foreach($all_products as $pd)
      ...
      <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <form action="{{ route('admin_products_recommends_updater') }}" method="POST">
          @csrf
...
<div class="col-md-6 col-12">
  <h3 class="text-muted text-center mb-4">Recommended Products List</h3>
  <ul class="list-group" id="sortable_list">
    @foreach($recommended_products as $pd)
      @php $img = json_decode($pd->images, true); @endphp
      <li class="list-group-item d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          <img src="{{ Storage::url($img[0]) }}" class="img-fluid rounded product_list_img mr-2">
