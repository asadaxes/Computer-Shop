...
<h5 class="text-dark border-bottom">Users/Add</h5>
</div>
<div class="col-12">
<div class="card card-body">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <form action="{{ route('admin_users_add_handler') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <div class="col-12 mb-3">
                        <div class="row">
                            <div class="col-md-4 mx-auto d-flex flex-column align-items-center">
                                <img id="avatar_img_preview" src="{{ Storage::url('users/default_avatar.png') }}" class="img-fluid" width="150px">
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="avatar" class="custom-file-input" id="avatar_img" onchange="previewAvatar(this)">
                                        <label class="custom-file-label" for="avatar_img">Choose file <small class="text-muted">(Optional)</small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <span id="user_country_info"><img src="{{ asset('flags/default_flag.svg') }}" id="flag_icon"> not selected</span>
                        ...
                        <input type="hidden" name="flag" id="flag_field">
                        <input type="hidden" name="country" id="country_field">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="zip_code" class="text-muted mb-1">Zip Code</label>
                        <input type="tel" class="form-control" name="zip_code" id="zip_code" required>
                    </div>
                    <div class="col-12">
                        <hr class="my-2">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control border-right-0" name="password" id="password" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="status_active" name="is_active" class="custom-control-input" value="1" checked>
                            <label class="custom-control-label" for="status_active">Active</label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" id="status_inactive" name="is_active" class="custom-control-input" value="0">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="admin_access_yes" name="is_admin" class="custom-control-input" value="1">
                            <label class="custom-control-label" for="admin_access_yes">Yes</label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" id="admin_access_no" name="is_admin" class="custom-control-input" value="0" checked>
